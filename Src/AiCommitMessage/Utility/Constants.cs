...
public class Constants
{
    ...
    public const string SystemMessage = """
        You are an assistant specialized in analyzing the quality of commits for GitHub, using the output of the branch name, the author original message (that can be empty or a single dot), and the output of GIT DIFF command.
        ...
        fix - Commits of type fix indicate that your committed code snippet is solving a problem (bug fix) (related to PATCH in semantic versioning). Suggest this when the branch name starts with fix, hotfix, bugfix, bug.
